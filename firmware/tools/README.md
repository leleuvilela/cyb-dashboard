...
# 3. Generate LVGL fonts (ASCII + Latin-1 accents + 6 icons: wifi/envelope/refresh/down/left/right)
for SZ in 14 16; do
  npx -y lv_font_conv --bpp 4 --size $SZ --format lvgl --force-fast-kern-format --no-compress \
    ...
    --font fa.woff -r 0xF1EB -r 0xF0E0 -r 0xF021 -r 0xF078 -r 0xF053 -r 0xF054
done
```
